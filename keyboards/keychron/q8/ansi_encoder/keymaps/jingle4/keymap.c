...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_ansi_69(
        ...
        _______, RGB_HUD,  RGB_HUI,  RGB_SAD, RGB_SAI, _______, _______,  _______, KC_UP, _______, _______,  _______,  _______,  _______,          _______,
        _______, RGB_VAD, RGB_VAI,  RGB_SPD, RGB_SPI, _______,           KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT,  _______,  _______,  _______,          _______,
    ...
    [_FN2] = LAYOUT_ansi_69(
        _______,  KC_BRID,  KC_BRIU,  KC_TASK, KC_FLXP, _______, _______,  _______, _______, _______, _______,  _______,  _______, KC_SLEP,          RGB_TOG,

...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ,---------------------------------------------------------------.
     * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =| Backsp|Grv|
     * |---------------------------------------------------------------|
     ...
     * |---------------------------------------------------------------|
     * |Ctrl | Fn | Alt |       Space          |Alt|Ctrl|  |Lef|Dwn|Rig|
     * `---------------------------------------------------------------'
     */
     ...
     * |---------------------------------------------------------------|
     * |LCGSWP|BLDC|BLSTP|BLINC|  |  |  |  | Up|  |   |   |   |    |mPP|
     * |-----------------------------------------------------------|---|
     * |LCGNRM|   |BLBR|  |   |   |Hom|Lef|Dwn|Rig|   |   |        |vUp|
     * |---------------------------------------------------------------|
     * |        |BLTGL| |   |   |Rbt|End|   |  |    |   |      |Up |vDn|
     * |---------------------------------------------------------------|
     * |     |    |     |                      |   |    |  |Prv|Clc|Nxt|
     * `---------------------------------------------------------------'
     */
    [1] = LAYOUT( \
        ...
        LCG_SWP,BL_DEC, BL_STEP,BL_INC, _______,_______,_______,_______,KC_UP,  _______, _______,_______,_______,_______,         KC_MPLY, \
        LCG_NRM,_______,BL_BRTG,_______,_______,_______,KC_HOME,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,         KC_VOLU,\
        _______,_______,BL_TOGG,_______,_______,_______,MD_BOOT,KC_END,_______,_______,_______,_______,_______,           KC_UP,  KC_VOLD,\
        _______,_______,_______,                        _______,                _______,_______,_______,         KC_MPRV, KC_CALC,KC_MNXT  \
    ) 
};
